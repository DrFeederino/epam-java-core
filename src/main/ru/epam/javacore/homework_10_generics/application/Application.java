package main.ru.epam.javacore.homework_10_generics.application;

import main.ru.epam.javacore.homework_10_generics.application.serviceholder.ServiceHolder;
import main.ru.epam.javacore.homework_10_generics.application.serviceholder.StorageType;
import main.ru.epam.javacore.homework_10_generics.cargo.domain.Cargo;
import main.ru.epam.javacore.homework_10_generics.cargo.domain.CargoField;
import main.ru.epam.javacore.homework_10_generics.cargo.search.CargoSearchCondition;
import main.ru.epam.javacore.homework_10_generics.cargo.service.CargoService;
import main.ru.epam.javacore.homework_10_generics.carrier.service.CarrierService;
import main.ru.epam.javacore.homework_10_generics.common.solutions.search.OrderType;
import main.ru.epam.javacore.homework_10_generics.common.solutions.utils.CollectionUtils;
import main.ru.epam.javacore.homework_10_generics.storage.initor.InMemoryStorageInitor;
import main.ru.epam.javacore.homework_10_generics.storage.initor.StorageInitor;
import main.ru.epam.javacore.homework_10_generics.transportation.service.TransportationService;
...
import static main.ru.epam.javacore.homework_10_generics.cargo.domain.CargoField.NAME;
import static main.ru.epam.javacore.homework_10_generics.cargo.domain.CargoField.WEIGHT;
import static main.ru.epam.javacore.homework_10_generics.common.solutions.search.OrderType.ASC;
import static main.ru.epam.javacore.homework_10_generics.common.solutions.search.OrderType.DESC;
