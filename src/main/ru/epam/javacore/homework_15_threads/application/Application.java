package main.ru.epam.javacore.homework_15_threads.application;

import main.ru.epam.javacore.homework_15_threads.application.serviceholder.ServiceHolder;
import main.ru.epam.javacore.homework_15_threads.application.serviceholder.StorageType;
import main.ru.epam.javacore.homework_15_threads.cargo.domain.Cargo;
import main.ru.epam.javacore.homework_15_threads.cargo.domain.CargoField;
...
import main.ru.epam.javacore.homework_15_threads.carrier.service.CarrierService;
...
import main.ru.epam.javacore.homework_15_threads.common.solutions.search.OrderType;
import main.ru.epam.javacore.homework_15_threads.common.solutions.utils.CollectionUtils;
import main.ru.epam.javacore.homework_15_threads.reporting.ReportDefaultService;
import main.ru.epam.javacore.homework_15_threads.reporting.ReportService;
import main.ru.epam.javacore.homework_15_threads.storage.initor.InitStorageType;
import main.ru.epam.javacore.homework_15_threads.storage.initor.StorageInitor;
import main.ru.epam.javacore.homework_15_threads.transportation.service.TransportationService;
...
import static main.ru.epam.javacore.homework_15_threads.cargo.domain.CargoField.NAME;
import static main.ru.epam.javacore.homework_15_threads.cargo.domain.CargoField.WEIGHT;
import static main.ru.epam.javacore.homework_15_threads.common.solutions.search.OrderType.ASC;
import static main.ru.epam.javacore.homework_15_threads.common.solutions.search.OrderType.DESC;
import static main.ru.epam.javacore.homework_15_threads.storage.initor.StorageInitorFactory.getStorageInitor;
