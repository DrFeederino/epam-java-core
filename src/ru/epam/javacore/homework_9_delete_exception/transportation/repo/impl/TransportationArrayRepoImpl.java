package ru.epam.javacore.homework_9_delete_exception.transportation.repo.impl;


import ru.epam.javacore.homework_9_delete_exception.common.solutions.utils.ArrayUtils;
import ru.epam.javacore.homework_9_delete_exception.storage.IdGenerator;
import ru.epam.javacore.homework_9_delete_exception.transportation.domain.Transportation;
import ru.epam.javacore.homework_9_delete_exception.transportation.repo.TransportationRepo;

import java.util.Arrays;
import java.util.List;

import static ru.epam.javacore.homework_9_delete_exception.common.business.repo.CommonRepoHelper.findEntityIndexInArrayStorageById;
import static ru.epam.javacore.homework_9_delete_exception.storage.Storage.transportationArray;
import static ru.epam.javacore.homework_9_delete_exception.storage.Storage.transportationIndex;
