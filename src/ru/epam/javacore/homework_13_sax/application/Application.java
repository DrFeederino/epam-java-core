package ru.epam.javacore.homework_13_sax.application;

import ru.epam.javacore.homework_13_sax.application.serviceholder.ServiceHolder;
import ru.epam.javacore.homework_13_sax.application.serviceholder.StorageType;
import ru.epam.javacore.homework_13_sax.cargo.domain.Cargo;
import ru.epam.javacore.homework_13_sax.cargo.domain.CargoField;
import ru.epam.javacore.homework_13_sax.cargo.search.CargoSearchCondition;
import ru.epam.javacore.homework_13_sax.cargo.service.CargoService;
import ru.epam.javacore.homework_13_sax.carrier.service.CarrierService;
...
import ru.epam.javacore.homework_13_sax.common.solutions.search.OrderType;
import ru.epam.javacore.homework_13_sax.common.solutions.utils.CollectionUtils;
import ru.epam.javacore.homework_13_sax.reporting.ReportDefaultService;
import ru.epam.javacore.homework_13_sax.reporting.ReportService;
import ru.epam.javacore.homework_13_sax.storage.initor.InitStorageType;
import ru.epam.javacore.homework_13_sax.storage.initor.StorageInitor;
import ru.epam.javacore.homework_13_sax.transportation.service.TransportationService;
...
import static ru.epam.javacore.homework_13_sax.cargo.domain.CargoField.NAME;
import static ru.epam.javacore.homework_13_sax.cargo.domain.CargoField.WEIGHT;
import static ru.epam.javacore.homework_13_sax.common.solutions.search.OrderType.ASC;
import static ru.epam.javacore.homework_13_sax.common.solutions.search.OrderType.DESC;
import static ru.epam.javacore.homework_13_sax.storage.initor.StorageInitorFactory.getStorageInitor;
