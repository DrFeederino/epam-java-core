package ru.epam.javacore.homework_11_file.transportation.repo.impl;


import ru.epam.javacore.homework_11_file.common.solutions.utils.ArrayUtils;
import ru.epam.javacore.homework_11_file.storage.IdGenerator;
import ru.epam.javacore.homework_11_file.transportation.domain.Transportation;
import ru.epam.javacore.homework_11_file.transportation.repo.TransportationRepo;

import java.util.Arrays;
import java.util.Collections;
import java.util.List;

import static ru.epam.javacore.homework_11_file.common.business.repo.CommonRepoHelper.findEntityIndexInArrayStorageById;
import static ru.epam.javacore.homework_11_file.storage.Storage.transportationArray;
import static ru.epam.javacore.homework_11_file.storage.Storage.transportationIndex;
