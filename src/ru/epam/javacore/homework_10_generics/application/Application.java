package ru.epam.javacore.homework_10_generics.application;

import ru.epam.javacore.homework_10_generics.application.serviceholder.ServiceHolder;
import ru.epam.javacore.homework_10_generics.application.serviceholder.StorageType;
import ru.epam.javacore.homework_10_generics.cargo.domain.Cargo;
import ru.epam.javacore.homework_10_generics.cargo.domain.CargoField;
import ru.epam.javacore.homework_10_generics.cargo.search.CargoSearchCondition;
import ru.epam.javacore.homework_10_generics.cargo.service.CargoService;
import ru.epam.javacore.homework_10_generics.carrier.service.CarrierService;
import ru.epam.javacore.homework_10_generics.common.solutions.search.OrderType;
import ru.epam.javacore.homework_10_generics.common.solutions.utils.CollectionUtils;
import ru.epam.javacore.homework_10_generics.storage.initor.InMemoryStorageInitor;
import ru.epam.javacore.homework_10_generics.storage.initor.StorageInitor;
import ru.epam.javacore.homework_10_generics.transportation.service.TransportationService;
...
import static ru.epam.javacore.homework_10_generics.cargo.domain.CargoField.NAME;
import static ru.epam.javacore.homework_10_generics.cargo.domain.CargoField.WEIGHT;
import static ru.epam.javacore.homework_10_generics.common.solutions.search.OrderType.ASC;
import static ru.epam.javacore.homework_10_generics.common.solutions.search.OrderType.DESC;
