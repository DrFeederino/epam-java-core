package ru.epam.javacore.homework_12_dom.transportation.repo.impl;


import ru.epam.javacore.homework_12_dom.common.solutions.utils.ArrayUtils;
import ru.epam.javacore.homework_12_dom.storage.IdGenerator;
import ru.epam.javacore.homework_12_dom.transportation.domain.Transportation;
import ru.epam.javacore.homework_12_dom.transportation.repo.TransportationRepo;

import java.util.Arrays;
import java.util.Collections;
import java.util.List;

import static ru.epam.javacore.homework_12_dom.common.business.repo.CommonRepoHelper.findEntityIndexInArrayStorageById;
import static ru.epam.javacore.homework_12_dom.storage.Storage.transportationArray;
import static ru.epam.javacore.homework_12_dom.storage.Storage.transportationIndex;
