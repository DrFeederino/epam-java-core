package ru.epam.javacore.homework_12_dom.application;

import ru.epam.javacore.homework_12_dom.application.serviceholder.ServiceHolder;
import ru.epam.javacore.homework_12_dom.application.serviceholder.StorageType;
import ru.epam.javacore.homework_12_dom.cargo.domain.Cargo;
import ru.epam.javacore.homework_12_dom.cargo.domain.CargoField;
import ru.epam.javacore.homework_12_dom.cargo.search.CargoSearchCondition;
import ru.epam.javacore.homework_12_dom.cargo.service.CargoService;
import ru.epam.javacore.homework_12_dom.carrier.service.CarrierService;
...
import ru.epam.javacore.homework_12_dom.common.solutions.search.OrderType;
import ru.epam.javacore.homework_12_dom.common.solutions.utils.CollectionUtils;
import ru.epam.javacore.homework_12_dom.reporting.ReportDefaultService;
import ru.epam.javacore.homework_12_dom.reporting.ReportService;
import ru.epam.javacore.homework_12_dom.storage.initor.InitStorageType;
import ru.epam.javacore.homework_12_dom.storage.initor.StorageInitor;
import ru.epam.javacore.homework_12_dom.transportation.service.TransportationService;
...
import static ru.epam.javacore.homework_12_dom.cargo.domain.CargoField.NAME;
import static ru.epam.javacore.homework_12_dom.cargo.domain.CargoField.WEIGHT;
import static ru.epam.javacore.homework_12_dom.common.solutions.search.OrderType.ASC;
import static ru.epam.javacore.homework_12_dom.common.solutions.search.OrderType.DESC;
import static ru.epam.javacore.homework_12_dom.storage.initor.StorageInitorFactory.getStorageInitor;
